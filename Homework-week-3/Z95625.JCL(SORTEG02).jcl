...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
    DELETE Z95625.QSAM.AA NONVSAM
    DELETE Z95625.QSAM.BB NONVSAM
    IF LASTCC LE 08 THEN SET MAXCC = 00
//SORT0200 EXEC PGM=SORT
//SYSOUT   DD SYSOUT=*
//SORTIN   DD *
10002949MELIH          CALMAZ         19960403
10002840MELIH          CALMAZ         19960403
10002978MELIH          CALMAZ         19960403
10001949ERHAN          KAPLAN         19910805
10001840ERHAN          KAPLAN         19910805
//SORTOUT  DD DSN=Z95625.QSAM.AA,
...
//FILE01   DD DSN=Z95625.QSAM.BB,
//             DISP=(MOD,DELETE,DELETE),SPACE=(TRK,0)
//SORT0400 EXEC PGM=SORT
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=Z95625.QSAM.AA,DISP=SHR
//SORTOUT  DD DSN=Z95625.QSAM.BB,
//            DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(5,5),RLSE),
